class VetsController < ApplicationController
  ...
  def destroy
    @vet.destroy
    respond_to do |format|
      format.html { redirect_to vets_url, notice: t('messages.delete.vet') }
  ...
  def vet_params
    params.require(:vet).permit(:name, :fone, :crv, address_attributes: %i[id street number complement neighborhood city state zip_code])
  end
end
