...
class VetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create vet' do
    assert_difference('Vet.count') do
      post vets_url, params: { vet: { address_id: @vet.address_id, crv: @vet.crv, fone: @vet.fone, name: @vet.name } }
    end
  ...
  test 'should update vet' do
    patch vet_url(@vet), params: { vet: { address_id: @vet.address_id, crv: @vet.crv, fone: @vet.fone, name: @vet.name } }
