...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create donation' do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { amount: @donation.amount, animal_id: @donation.animal_id, donorType_id: @donation.donorType_id, person: @donation.person } }
    end
  ...
  test 'should update donation' do
    patch donation_url(@donation), params: { donation: { amount: @donation.amount, animal_id: @donation.animal_id, donorType_id: @donation.donorType_id, person: @donation.person } }
